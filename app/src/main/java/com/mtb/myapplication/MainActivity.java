...
public class MainActivity extends AppCompatActivity {
    // creating variables for our array list, recycler view progress bar and
    // adapter.
    private ArrayList<ContactsModal> contactsModalArrayList;
    private RecyclerView contactRV;
    private ContactRVAdapter contactRVAdapter;
    private ProgressBar loadingPB;
    FloatingActionButton addNewContactFAB;
    ...
    private void filter(String text) {
        ...
        // on below line we are running a loop for checking if the item is present in
        // array list.
                ...
                .withListener(new MultiplePermissionsListener() {
                    ...
                    public void onPermissionsChecked(MultiplePermissionsReport multiplePermissionsReport) {
                        ...
                        if (multiplePermissionsReport.areAllPermissionsGranted()) {
                            // do you work now
                            getContacts();
                            Toast.makeText(MainActivity.this, "All the permissions are granted..", Toast.LENGTH_SHORT)
                                    .show();
                        }
                    ...
                    public void onPermissionRationaleShouldBeShown(
                            List<com.karumi.dexter.listener.PermissionRequest> list, PermissionToken permissionToken) {
    ...
    private void getContacts() {
        ...
        if (cursor.getCount() > 0) {
            // if the count is greater than 0 then we are running a loop to move our cursor
            // to next.
            while (cursor.moveToNext()) {
                ...
                if (hasPhoneNumber > 0) {
                    ...
                    if (phoneCursor.moveToNext()) {
                        // on below line we are getting the phone number for our users and then adding
                        // the name along with phone number in array list.
